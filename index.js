...
const usePairingCode = false; // ❌ we are not using QR/pairing anymore
...
const saveState = async () => {
    console.log(chalk.yellow("⚡ Session updated in memory"))
}
// =========================================================== //
...
const phoneNumber = await question(chalk.blue.bold("Thanks for choosing TREND-X. please provide your number start with  254xxx:\n"));
const code = await conn.requestPairingCode(phoneNumber.trim())
console.log(chalk.cyan(`Code : ${code}`))
console.log(chalk.cyan(`鈺戔灣 Trend-x
...
const memberCount = groupMetadata.participants.length;
      await conn.sendMessage(anu.id, {
        image: { url: ppUrl },
        caption: `
  鈺戔灣  *TREND-X welcome*@${participant.split('@')[0]}  
